...
easy_difficulty_button_rect = easy_difficulty_button_text.get_rect(
    center=(SCREEN_WIDTH // 2, SCREEN_HEIGHT // 3)
)

medium_difficulty_button_text = font.render("MEDIO", True, (150, 210, 255))
medium_difficulty_button_rect = medium_difficulty_button_text.get_rect(
    center=(SCREEN_WIDTH // 2, SCREEN_HEIGHT // 3 + 75)
)

hard_difficulty_button_text = font.render("DIFFICILE", True, (200, 230, 255))
hard_difficulty_button_rect = hard_difficulty_button_text.get_rect(
    center=(SCREEN_WIDTH // 2, SCREEN_HEIGHT // 3 + 150)
)
...
def main() -> None:
    ...
    def controlla_vittoria():
        ...
        for r in range(9):
            ...
            for c in range(9):
                ...
                if (
                    user_puzzle[r][c] == "."
                    or user_puzzle[r][c] != soluzione_completa[r][c]
                ):
                    return False
        return True
    ...
    def genera_puzzle(opzione: str):
        ...
        print("Puzzle Generato:", user_puzzle)
    ...
    while running:
        ...
        if (
            ...
            and casella_selezionata is not None
            and STATE == "playing"
            and puzzle != None
            and user_puzzle != None
        ):
        ...
        if STATE == "playing" and puzzle != None and user_puzzle != None:
            ...
            for x in range(9):
                linee_orizzontali = pygame.draw.line(
                    screen, "black", (150, 150 + (100 * x)), (1050, 150 + (100 * x)), 5
                )
                linee_verticali = pygame.draw.line(
                    screen, "black", (250 + (100 * x), 50), (250 + (100 * x), 950), 5
                )

            # linee più spesse che creano la griglia tipica del sudoku
            for y in range(4):
                spesse_orizzontali = pygame.draw.line(
                    screen, "black", (150, 50 + (300 * y)), (1050, 50 + (300 * y)), 10
                )
                spesse_verticali = pygame.draw.line(
                    screen, "black", (150 + (300 * y), 50), (150 + (300 * y), 950), 10
                )
            ...
            for i in range(len(lista_pulsanti)):
                ...
                if casella_selezionata == i:
                    ...
                    pygame.draw.rect(
                        screen, (235, 245, 255), casella_piccola, border_radius=8
                    )
                ...
                if str(valore_da_disegnare) not in [".", ""]:
                    ...
                    if puzzle[riga - 1][colonna - 1] != ".":
                        ...
                        valido = mossa_valida(
                            user_puzzle, riga - 1, colonna - 1, valore_da_disegnare
                        )
            ...
            if controlla_vittoria():
                ...
                messaggio_rect = pygame.Rect(
                    SCREEN_WIDTH // 2 - 350, SCREEN_HEIGHT // 2 - 90, 600, 180
                )
                ...
                testo_info = font_info.render(
                    "Il tempo impiegato è scritto nel file risultati_sudoku.txt",
                    True,
                    "white",
                )
                info_rect = testo_info.get_rect(
                    center=(messaggio_rect.centerx, messaggio_rect.bottom - 45)
                )
                # scriviamo il font nello schermo
        ...
        # disegna tutte le cose del menu iniziale
            ...
            pygame.draw.rect(
                ...
                (30, 60, 120),
                (
                    easy_difficulty_button_rect.topleft[0] - 15,
                    easy_difficulty_button_rect.topleft[1] - 5,
                    easy_difficulty_button_rect.width + 30,
                    easy_difficulty_button_rect.height + 10,
                ),
            )
            ...
            pygame.draw.rect(
                ...
                (40, 80, 150),
                (
                    medium_difficulty_button_rect.topleft[0] - 15,
                    medium_difficulty_button_rect.topleft[1] - 5,
                    medium_difficulty_button_rect.width + 30,
                    medium_difficulty_button_rect.height + 10,
                ),
            )
            ...
            pygame.draw.rect(
                ...
                (50, 100, 170),
                (
                    hard_difficulty_button_rect.topleft[0] - 15,
                    hard_difficulty_button_rect.topleft[1] - 5,
                    hard_difficulty_button_rect.width + 30,
                    hard_difficulty_button_rect.height + 10,
                ),
            )
            ...
            screen.blit(
                immagine_sinistra,
                (
                    easy_difficulty_button_rect.left - 245,
                    easy_difficulty_button_rect.centery - 60,
                ),
            )
            ...
            screen.blit(
                immagine_destra,
                (
                    hard_difficulty_button_rect.right + 30,
